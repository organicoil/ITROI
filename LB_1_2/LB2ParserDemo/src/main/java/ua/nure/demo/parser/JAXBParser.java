...
public class JAXBParser {
     ...
     */
    private static Orders loadOrders(final String xmlFileName,
     ...
     */
    private static void saveOrders(Orders orders, final String xmlFileName,
            final String xsdFileName, Class<?> objectFactory) throws JAXBException, SAXException {
        JAXBContext jc = JAXBContext.newInstance(objectFactory);
        ...
        marshaller.setProperty(Marshaller.JAXB_SCHEMA_LOCATION, Constants.SCHEMA_LOCATION_URI);
    ...
    public static void main1(String[] args) throws JAXBException, FileNotFoundException {
        JAXBContext jc = JAXBContext.newInstance(Constants.OBJECT_FACTORY);
        Unmarshaller um = jc.createUnmarshaller();
        Orders orders = (Orders) um.unmarshal(new FileInputStream(Constants.ORDERS_XML_PATH));
    ...
    public static void main(String[] args) throws JAXBException, SAXException {
        ...
        // warning)
        Orders orders = loadOrders(Constants.ORDERS_XML_PATH, Constants.ORDERS_XSD_FILE, Constants.OBJECT_FACTORY);
        ...
        try {
            saveOrders(orders, Constants.ORDERS_XML_PATH + ".jaxb.xml", Constants.ORDERS_XSD_FILE, Constants.OBJECT_FACTORY);
        } catch (Exception ex) {
            System.err.println("====================================");
