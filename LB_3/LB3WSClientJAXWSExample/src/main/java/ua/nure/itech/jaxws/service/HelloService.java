 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://service.jaxws.itech.nure.ua/", wsdlLocation = "http://localhost:9090/HelloPort?wsdl")
public class HelloService extends Service {
	...
	static {
		...
		try {
			url = new URL("http://localhost:9090/HelloPort?wsdl");
