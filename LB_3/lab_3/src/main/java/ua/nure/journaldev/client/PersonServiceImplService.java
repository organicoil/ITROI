 ...
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://impl.service.server.journaldev.nure.ua/", wsdlLocation = "http://localhost:8888/ws/person?wsdl")
public class PersonServiceImplService extends Service {
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.server.journaldev.nure.ua/", "PersonServiceImplService");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("http://impl.service.server.journaldev.nure.ua/", "PersonServiceImplPort"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.server.journaldev.nure.ua/", "PersonServiceImplPort"), PersonService.class, features);
    }
